...
export default function RoomPage() {
    ...
    const createRoom = async () => {
        ...
        try {
            ...
            const errorMsg = error.response?.data?.message || error.message || "Failed to create room. Please try again.";
            setMessage(`❌ ${errorMsg}`);
        }
    };
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-white selection:bg-indigo-500/30">
            ...
            <main className="container mx-auto px-6 py-12 max-w-5xl">
                ...
                {message && (
                    <div className="mb-8 p-4 bg-red-500/10 border border-red-500/20 text-red-400 rounded-xl flex items-center gap-3 animate-fade-in-up">
